...
class ConversorTemporalController extends Controller
{
    ...
    public function test($crypto = null, $fecha = null)
    {
        $key_access = '543b059531a78426c2ea48612a9d8523';
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://api.coinlayer.com/api/".$fecha."?access_key=".$key_access."&symbols=".$crypto,
