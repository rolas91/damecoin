...
class PaymentWallControllerMP extends Controller
{
    /**
 ...
 public function update(Request $request, PaymentWallTransaction $transaction)
    ...
    public function createProcessFaster($idDivisa,$idCrypto,$total,$user,$tipo,$metodo,$direct){
        ...
        $totalDeposit = ($totalx -($totalx*($currency->detailCurrency->comision_abono/100)));    
        $descuento=General::getDescuento($totalDeposit,$getCriptodefault->maker_fee);
