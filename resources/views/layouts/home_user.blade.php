...
.left-addon select  { padding-left:  60px; }
.right-addon select { padding-right: 60px; }
.subt{
  margin:0;
  padding:0;
  ...
  <body layout="row" ng-controller="AppCtrl">
    <md-sidenav layout="column" class="md-sidenav-left md-whiteframe-z2" md-component-id="left" md-is-locked-open="$mdMedia('gt-md')">
      ...
      <a href="{{url('/buy')}}/{{General::getCryptoDefault('btc')}}/{{General::getDivisaDefault()}}">
         ...
         <!--carteras-->
        <md-item>
        <a href="{{url('/carteras')}}/{{General::getDivisaDefault()}}">
              <md-item-content md-ink-ripple layout="row" layout-align="start center">
                <div class="inset">
                  <ng-md-icon icon=""></ng-md-icon>
                </div>
                <div class="inset">Carteras
                </div>
              </md-item-content>
            </a>
          </md-item>
      ...
      <md-subheader>Ajustes</md-subheader>
      <!--comprar-->
      <md-item>
        <a>
          <md-item-content md-ink-ripple layout="row" layout-align="start center">
    ...
    <div layout="column" class="relative" layout-fill role="main">
      ...
      <md-content class="md-padding">@yield('content')</md-content>
    ...
    <script>var app = angular.module('StarterApp', ['ngMaterial', 'ngMdIcons']);
