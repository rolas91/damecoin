             ...
             <form
                ...
                <div class="row sign">
                   <div class="col-md-12 d-flex justify-content-start align-items-center flex-wrap">
                      ...
                      <h5 class="font-weight-bold">@lang('index.pagoconAlipay')</h5>
                      <small class="ml-auto font-size-xsmall"> <img src="{{asset('img/alert-circle.png')}}" alt="">  <span id="minAlipay">{{$result['minUsd']}}({{$result['min']}})</span></small>
                  </div>
 
                  <div class="col-md-12 mt-3">
                      <p class="mx-0 font-size-small">
                          @lang('index.TextGeneric1') 
                          <span id="minAlipayP">{{$result['minUsd']}}({{$result['min']}})</span>
                  ...
                  <div class="col-md-12 ">
                      <div>
                           <div class="card-pasos ">
                            ...
                            <div class="card-blue p-2" style="background:#1678FF">
                               <p class=" font-size-normal m-0 color-black">@lang('index.enviar') <span class="h6 color-black" id="pay"></span> @lang('index.usd')</p>
                               <p class=" h6 m-0">
                                    <div>
                                        <img width="70%" src="{{asset('/methodpayQR/'.$result['imagen'])}}" alt="" id="alipayimagenUp">
                                     </div>
                               </p>
                            </div>
                        </div>
