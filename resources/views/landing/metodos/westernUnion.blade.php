<style>
               ...
               >
                ...
                <div class="row sign">
                   <div class="col-md-12 d-flex justify-content-start align-items-center flex-wrap">
                      <img class="mr-3" src="{{asset($data->file)}}" alt="">
                      <h5 class="font-weight-bold">{{$data->name}}</h5>
                      <small class="ml-auto font-size-xsmall"> <img src="{{asset('img/alert-circle.png')}}" alt=""> Minimum {{ $data->amount }} USD ({{ $default['conversor'] }} EUR)</small>
                  </div>
 ...
 setInterval(() => {
    ...
    $('#botom').click(() => {
       ...
       // formData.append('amount',formatMoney('{{ $data->amount }}'));
