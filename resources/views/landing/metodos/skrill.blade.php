             ...
             <form
                ...
                <div class="row sign">
                   <div class="col-md-12 d-flex justify-content-start align-items-center flex-wrap">
                      <img class="mr-3" src="{{asset('assets/img/formSkrill/Ellipse58.png')}}" alt="">
                      <h5 class="font-weight-bold">@lang('index.pagoSkrill')</h5>
                      ...
                      <div>
                           <div class="card-pasos ">
                            ...
                            <div class="card-blue p-2">
                               ...
                               <p class=" h6 m-0">{{ $limit_pay[0]->skrill_email}}</p>
                            </div>
                        </div>
