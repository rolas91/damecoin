         ...
         <div class="container_prices_list">
            ...
            @php
               if($data[0]->form == 0)
               {
                  // Generico
                  @endphp
                     @include('partials.formGeneric')
                  @php   
               }elseif ($data[0]->form == 1)
               {
                  // Paypal
                  @endphp
                     @include('partials.formPay2')
                  @php   
               }
               elseif ($data[0]->form == 2)
               {
                  // Western Union
                  @endphp
               ...
               elseif ($data[0]->form == 3)
               {
                  // Bizum
                  @endphp
                     @include('partials.formBizum')
                  @php   
               }
               elseif ($data[0]->form == 4)
               {
                  @endphp
                     @include('partials.formSkrill2')
                  @php   
               }
            @endphp
