...
<div class="container_prices_list">
          ...
          <div class="d-flex flex-wrap">
             ...
             <div class="col-md-6 padding-md-0 
                ...
                <div class="custom-control custom-radio radio-amount">
                   @if($index == 2)
                   <input type="radio" id="amount-{{$panel['id']}}" value="{{$panel['pagar']}}" name="amount" class="custom-control-input radioBtnClass person showp" checked>
                   @else
                   <input type="radio" id="amount-{{$panel['id']}}" value="{{$panel['pagar']}}" name="amount" class="custom-control-input radioBtnClass person showp">
                   @endif
                   <label class="custom-control-label" for="{{$panel['id']}}">
                   <span>
                   <small>@lang('index.pay')</small>
                   <strong id="pag">{{$panel["pagar"]}}
          ...
          <div class="row" id="numbers-one">
             <div class="col-md-6">
                <div class="radio-amount-new pb-0">
                   <div class="areaCl d-flex">
                      <input type="radio" id="customBuy" name="amount" class="custom-control-input radioBtnClassCustom person showp" value="{{$default['pay']}}" >
                ...
                <div class="input-group input-group-cantidad mb-3">
                  <input type="text" class="form-control base" id="persoCrypto" value="{{$default['recibe']}}" onKeyPress="return soloNumeros(event)" aria-label="Amount (to the nearest dollar)">
             ...
             <div class="col-md-6">
                ...
                <div class="input-group input-group-cantidad mb-3">
                  <input type="text" class="form-control base" id="persoCurrency" value="{{$default['pay']}}" onKeyPress="return soloNumeros(event)" onkeyup="document.getElementById('customBuy').value=this.value; newChecked(this);" aria-label="Amount (to the nearest dollar)">
                  <div class="input-group-append">
                    <span class="input-group-text">
