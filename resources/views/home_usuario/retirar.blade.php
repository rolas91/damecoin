...
<form action="/processretiro" method="post" id="retiro">
    ...
    <div class="row" style="padding:20px;background-color:#ccc;margin:10px" >
        ...
        <div class="input-group">
            ...
            <input class="form-control" id="totalCurrency" type="number" name='totalCurrency' value="" placeholder="{{$totalCurrency}}" required>
        ...
        @endif
        <p class="badge" style="margin-top: 20px;background: #2196F3">@lang('home_retiro.saldo')  {{ $totalCurrency}} {{$getCurrencyUser->code}} </p> 
    </div>
...
<div class="row">
    ...
    <div class="col-sm-6">
            <p class="final">@lang('home_retiro.totalt') <span id="total">   </span> {{$getCurrencyUser->code}}</p> 
            {{--  <p class="final">@lang('home_retiro.comisiont') {{ $getCurrencyUser->detailCurrency->comision_retiro }} % :<span id="comision"></span>  {{$getCurrencyUser->code}} </p>   --}}
        <button type="submit" id="xxx" class="btn btn-warning mibutom pull-right">@lang('home_retiro.bottonretiro') {{$getCurrencyUser->code}}  </button>
...
<div class="alert alert-danger alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h4><i class="icon fa fa-ban"></i>  @lang('home_retiro.sinsaldo',["currency"=>$getCurrencyUser->code])</h4>
...
<script>
        ...
        function multi(){
            ...
            var comision=parseFloat({{ $getCurrencyUser->detailCurrency->comision_retiro  }});
            if(isNaN(currency)){
