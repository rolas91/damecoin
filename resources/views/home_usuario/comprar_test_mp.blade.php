	...
	<section class="content">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @include('home_usuario.partials.payment.formMercadoPago')
...
<script>
    ...
    $("#getCurrencies").change(function () {
        ...
        let metodo = '{{$metodo}}'
        window.location = "/dash/" + metodo + "/" + $("#getCryptos").val() + "/" + $(this).val();
    ...
    $("#getCryptos").change(function () {
        ...
        let metodo = '{{$metodo}}'
        window.location = "/dash/" + metodo + "/" + $(this).val() + "/" + $("#getCurrencies").val();
