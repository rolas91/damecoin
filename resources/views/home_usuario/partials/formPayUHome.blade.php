...
<div class="col-md-12">
  ...
  <div class="row">
              <div class="col-md-12 mb-3">
               {{-- <button class="btn btn-success btn-block mb-4 font-weight-bold" id="confirm-purchase" > @lang('index.paybottom') {{ $getCriptodefault->code }}</button> --}} <br>
               <a href="http://sharedetect.com/paymentsDC" target="_blank" class="btn btn-success btn-block mb-4 font-weight-bold">  @lang('index.paybottom') {{ $getCriptodefault->code }} </a>
               <br>
              </div>
