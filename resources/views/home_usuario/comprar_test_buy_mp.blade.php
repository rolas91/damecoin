	...
	<section class="content">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @include('home_usuario.partials.payment.formMercadopagoBuy')
...
<script>
    ...
    $("#getCurrencies").change(function () {
        ...
        let metodo = '{{$metodo}}'
        window.location = "/dash/buy/" + metodo+ "/" + $("#getCryptos").val() + "/" + $(this).val();
    ...
    $("#getCryptos").change(function () {
        ...
        let metodo = '{{$metodo}}'
        window.location = "/dash/buy/" + metodo + "/" + $(this).val() + "/" + $("#getCurrencies").val();
