        ...
        <div class="container">
            <div layout="row" layout-xs="column">
                <div flex="" style="background:#ccc;padding:10px;margin:2px">
                    ...
                    <div class="row">
                        <div class='col-sm-6'>
                            {!! Form::select('getCurrencies', $getCurrencies, $default->id, ['id' => 'getCurrencies',
                            'class' => 'form-control']) !!}
                        </div>
                    </div>
            ...
            <div layout="row" layout-xs="column">
                @forelse($cryptos as $crypto)
                    <div flex="" style="background:#ccc;padding:10px;margin:2px">
                        ...
                        <h2> <?php echo $default->code . ' ' . General::getConverCrypto($default->code,
                            $crypto->code, $z); ?> </h2>
                        ...
                        <div layout="row">
                            ...
                            <div flex="30">
                                <md-button class="md-primary"><a
                                        href="/dash/buy/{{ $crypto->id }}/{{ $default->id }}">comprar</a></md-button>
                            </div>
                            <div flex="30">
                                <md-button class="md-primary"><a href="/vender/{{ $crypto->id }}/{{ $default->id }}">vender</a>
                                </md-button>
                            </div>
                        </div>
                    </div>
