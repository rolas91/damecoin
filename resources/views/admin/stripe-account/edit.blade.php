...
<div class="content-wrapper">
        ...
        <form action="{{ url('admin/stripe-account/'.$stripe->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
             ...
             <div class="row">
                <div class="col-md-8 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                    <input id="name" type="text" class="form-control"  value="{{ $stripe->name }}" name="name" value="{{ old('name') }}">
            ...
            <div class="row">
                <div class="col-md-8 form-group{{ $errors->has('stripe_id') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                    <input id="stripe_id" type="text" class="form-control" value="{{ $stripe->stripe_id }}" name="stripe_id" value="{{ old('stripe_id') }}">
            ...
            <div class="row">
                <div class=" col-md-8 form-group{{ $errors->has('secure_3d') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                    {!!Form::select('secure_3d', [0 => 'No',1=>'Yes'],$stripe->secure_3d, [
                                        'id' => 'secure_3d',
                                        'class' => 'form-control'
                                    ])!!}
            ...
            <div class="row">
                <div class="col-md-8 form-group{{ $errors->has('user_by') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                    <input id="user_by" type="text" class="form-control" value="{{ $stripe->user_by }}"  name="user_by" value="{{ old('user_by') }}">
            ...
            <div class="row">
                <div class="col-md-8 form-group{{ $errors->has('email_owner') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                    <input id="email_owner" type="email" class="form-control" value="{{ $stripe->email_owner }}"  name="email_owner" value="{{ old('email_owner') }}">
            ...
            <div class="row">
                <div class="col-md-8 form-group{{ $errors->has('email_admin') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                    <input id="email_admin" type="email" class="form-control"  value="{{ $stripe->email_admin }}" name="email_admin" value="{{ old('email_admin') }}">
