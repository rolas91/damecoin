...
<div class="content-wrapper">
        ...
        <form action="{{ url('admin/bank') }}" method="POST" class="form-horizontal">
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('destinatary') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="destinatary" type="text" class="form-control"  name="destinatary" value="{{ old('destinatary') }}" autofocus>
                ...
                <div class="form-group{{ $errors->has('addres') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="addres" type="text" class="form-control" name="addres"  value="{{ old('addres') }}" >
                ...
                <div class="form-group{{ $errors->has('numero_cuenta') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="numero_cuenta" type="text" class="form-control" name="numero_cuenta"  value="{{ old('numero_cuenta') }}" >
