...
<div class="content-wrapper">
        ...
        <form action="{{ url('admin/currency') }}" method="POST" class="form-horizontal">
                {{ csrf_field() }}
                ...
                <div class="form-group {{ $errors->has('symbol') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="symbol" type="text" class="form-control" name="symbol"   value="{{ old('symbol') }}" maxlength="20">
                ...
                <div class="form-group {{ $errors->has('isocode') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="isocode" type="text" class="form-control" name="isocode"  value="{{ old('isocode') }}" maxlength="2">
                ...
                <div class="form-group {{ $errors->has('min_deposito') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="min_deposito" type="text" class="form-control" name="min_deposito"  value="{{ old('min_deposito') }}" >
                ...
                <div class="form-group {{ $errors->has('max_deposito') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="max_deposito" type="text" class="form-control" name="max_deposito" value="{{ old('max_deposito') }}" >
                ...
                <div class="form-group {{ $errors->has('comision_abono') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="comision_abono" type="number" class="form-control" name="comision_abono"  value="{{ old('comision_abono') }}" >
                ...
                <div class="form-group {{ $errors->has('comision_retiro') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="comision_retiro" type="number" class="form-control" name="comision_retiro"  value="{{ old('comision_retiro') }}" >
