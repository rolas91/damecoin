...
<div class="modal fade" id="SkrillPaymentModal" tabindex="-1" role="dialog" aria-labelledby="SkrillPaymentLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background: #ecf0f5;">
            <div class="modal-header" style="padding: 20px 30px 10px;">
                <h4 class="modal-title" id="SkrillPaymentLabel">Skrill</h4>
...
<a href="#" class="btn btn-primary" style="display: flex;align-items: center;" data-toggle="modal"
    data-target="#SkrillPaymentModal" onclick="newSkrill()">
    <img src="{{ asset('assets/img/formSkrill/Ellipse58.png') }}" class="left-icon" style="width: 25px;">
    Skrill
</a>
...
<script>
    function newSkrill() {
        ...
        calculateMinimum(currency, "skrill")
            .then((data) => {
