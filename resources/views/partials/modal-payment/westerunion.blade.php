{{-- Wester Union --}}
<div class="modal fade" id="westernUnionPaymentModal" tabindex="-1" role="dialog"
    aria-labelledby="westernUnionPaymentLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="background: #ecf0f5;">
            ...
            <div class="modal-body" style="padding: 20px 30px;">
                <div class="text-center mb-2">
                    <img loading="lazy"
                        src="https://lh3.googleusercontent.com/r1qrqwYTNX0x1fN_0Xty0JWzkKBgad0RylI6rmGsRg144dvrRoKuZFqMJssOHhaPtA"
...
<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#westernUnionPaymentModal"
