{{-- Paypal --}}
<div class="modal fade" id="ModalPaypal" tabindex="-1" role="dialog" aria-labelledby="westernUnionPaymentLabel"
    aria-hidden="true">
...
<a data-toggle="modal" data-target="#ModalPaypal" class="btn btn-primary"
    style="color:#fff;display: flex;align-items: center;" onclick="newPaypal()">
...
<script>
    function newPaypal() {
        ...
        calculateMinimum(currency, "paypal")
            .then((data) => {
